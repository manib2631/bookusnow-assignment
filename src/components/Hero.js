...
function Hero() {
  return (
    <div className="mt-2 relative hero">
      {/* Image */}
      ...
      {/* Heading */}
      <div className="absolute top-150px text-white w-full text-center banner-content  ">
        <div className="text-4xl w-7/12 mx-auto font-semibold leading-snug">
